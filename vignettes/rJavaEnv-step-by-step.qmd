...
dir.create("distrib_cache")
```

The code in examples will use the temporary directory created above.
...
```{r}
java_17_distr <- java_download(version = 17, distribution_cache_path = "distrib_cache/")
java_17_distr
```
