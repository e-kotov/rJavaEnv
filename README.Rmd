...
This will:
  ...
  - create a symbolic link (for macOS and Linux) or junction (for Windows) **rjavaenv/`platform`/`processor_architecture`/`java_version`** in the current directory/project to point to the cached installation;
...
See more details on the functions that help manage the cached distributions, installations and more in the [Reference](https://e-kotov.github.io/rJavaEnv/reference/index.html){target="_blank"}.
