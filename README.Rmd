...
The future work includes:
  ...
  - Possibly adding support for specifying Java version beyond the major version
  
  - Possible allow downloading several Java distributions at once, e.g. different major versions of the same 'flavour' or different 'flavours' of the same major version
