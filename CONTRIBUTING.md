# Contributing to rJavaEnv

This outlines how to propose a change to rJavaEnv. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("e-kotov/rJavaEnv", fork = TRUE)`.
...
Please note that the rJavaEnv project is released with a [Contributor
Code of Conduct](https://www.ekotov.pro/rJavaEnv/CODE_OF_CONDUCT.md). By
