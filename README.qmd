...
[![CRAN/METACRAN Total downloads](https://cranlogs.r-pkg.org/badges/grand-total/rJavaEnv?color=blue)](https://CRAN.R-project.org/package=rJavaEnv){target="_blank"}ges
