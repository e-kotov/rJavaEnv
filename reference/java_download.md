...
#> [1] "/tmp/RtmpxSZU0P/rJavaEnv_cache/distrib/amazon-corretto-17.0.19.10.1-linux-x64.tar.gz"
#> attr(,"distribution")
#> [1] "Corretto"
#> attr(,"backend")
#> [1] "native"
...
#> Checksum verified.
#> [1] "/tmp/RtmpxSZU0P/rJavaEnv_cache/distrib/amazon-corretto-21.0.11.10.1-linux-x64.tar.gz"
#> attr(,"distribution")
#> [1] "Corretto"
#> attr(,"backend")
#> [1] "native"
...
#> [1] "/tmp/RtmpxSZU0P/rJavaEnv_cache/distrib/corretto-21-linux-x64.tar.gz"
#> attr(,"distribution")
#> [1] "Corretto"
#> attr(,"backend")
#> [1] "sdkman"
