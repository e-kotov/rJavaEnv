...
#> Java distribution amazon-corretto-17.0.19.10.1-linux-x64.tar.gz already
#> unpacked at
...
#> ✔ Current R Project/Working Directory: JAVA_HOME and PATH set to '/home/runner/.cache/R/rJavaEnv/installed/linux/x64/Corretto/native/17' in .Rprofile at '/tmp/RtmpZzCBbW/rJavaEnv_project'
...
#> symlinked to
#> /tmp/RtmpZzCBbW/rJavaEnv_project/rjavaenv/linux/x64/Corretto/native/NA
# }
```
