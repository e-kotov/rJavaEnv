...
#> ✔ Current R Project/Working Directory: JAVA_HOME and PATH set to '/home/runner/.cache/R/rJavaEnv/installed/linux/x64/Corretto/native/17' in .Rprofile at '/tmp/Rtmpq5yBHF/rJavaEnv_project'
...
#> symlinked to
#> /tmp/Rtmpq5yBHF/rJavaEnv_project/rjavaenv/linux/x64/Corretto/native/NA
# }
```
