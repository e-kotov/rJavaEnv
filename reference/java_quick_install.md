...
#> ✔ Current R Project/Working Directory: JAVA_HOME and PATH set to '/home/runner/.cache/R/rJavaEnv/installed/linux/x64/Corretto/native/17' in .Rprofile at '/tmp/RtmpSrQMTm/rJavaEnv_project'
...
#> symlinked to
#> /tmp/RtmpSrQMTm/rJavaEnv_project/rjavaenv/linux/x64/Corretto/native/NA
# }
```
